...
//     const bot = new TelegramBot(NOTIFICATION_API.authBotToken, { polling: true });
...
//       /\/start/,
//       async (msg) =>
//         await bot.sendMessage(msg.chat.id, `Welcome, ${msg.chat.first_name}! Notification bot is activated.`),
//     );
